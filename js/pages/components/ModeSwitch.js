...
export default {
    ...
    emits: ['update:mode'],
    template: `
        <button class="flex items-center justify-center w-9 h-9 rounded-full bg-blue-600 text-white hover:bg-blue-700 transition" @click="$emit('update:mode', mode === 'setting' ? 'working' : 'setting')">
